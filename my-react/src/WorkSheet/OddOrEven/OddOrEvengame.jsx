...
if (isTeacher) {
return ( <div className="odd-even-minigame teacher-odd-even"> <h2>{game.name}</h2>
    ...
    <p>
      Children will have to decide if a number is
      odd or even.
    </p>
  </div>
);
...
return ( <div className="odd-even-minigame"> <h2>{game.name}</h2>
